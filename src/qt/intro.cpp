...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Las Vegas Coin Core"),
     ...
     * override -datadir in the lasvegascoin.conf file in the default data directory
     * (to be consistent with lasvegascoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
