...
/** Utility functions used by the Las Vegas Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render Las Vegas Coin addresses in monospace font
...
// Parse "lasvegascoin:" URI into recipient object, return true on successful parsing
