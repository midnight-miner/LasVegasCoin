                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Las Vegas Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Las Vegas Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lasvegascoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Las Vegas Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Las Vegas Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Las Vegas Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Las Vegas Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Las Vegas Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Las Vegas Coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Las Vegas Coin Core help message to get a list with possible Las Vegas Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Las Vegas Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Las Vegas Coin network", "", count));
}
...
{
    QString strTitle = tr("Las Vegas Coin Core"); // default title
    ...
    // Append title to "Las Vegas Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
