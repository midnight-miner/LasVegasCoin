...
static const char UNUSED* pivx_strings[] = {
    ...
    QT_TRANSLATE_NOOP("pivx-core", "Connect to KeePassHttp on port <port> (default: %u)"),
    ...
    QT_TRANSLATE_NOOP("pivx-core", "KeePassHttp id for the established association"),
    QT_TRANSLATE_NOOP("pivx-core", "KeePassHttp key for AES encrypted communication with KeePass"),
    ...
    QT_TRANSLATE_NOOP("pivx-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
