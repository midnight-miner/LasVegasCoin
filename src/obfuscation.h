...
static const int64_t OBFUSCATION_POOL_MAX = (9999999 * CENT);  // Equal to 99999.99 * COIN but remains in int64 with no rounding errors.
...
{
public:
    /// Is the inputs associated with this public key? (and there is 50 VGS - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of lasvegascoin.
