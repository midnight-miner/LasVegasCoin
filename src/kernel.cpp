...
int nStakeTargetSpacing = 60 * 5; // 5 minute stake time
...
{
    //LasVegasCoin will hash in the transaction hash and the index number in order to make sure each hash is unique
