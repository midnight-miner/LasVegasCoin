Contributing to Las Vegas Coin Core
============================

The Las Vegas Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Las Vegas Coin Core project, and is not to be
confused with overall Las Vegas Coin Network Protocol consensus changes.

Whether a pull request is merged into Las Vegas Coin Core rests with the project merge
...
Patches that change Las Vegas Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Las Vegas Coin consensus, it must have been
...
The project leader is the release manager for each Las Vegas Coin Core release.
