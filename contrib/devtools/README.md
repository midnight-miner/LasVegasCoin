...
Las Vegas Coin-Project/Las Vegas Coin repository.
...
Setup
---------
Configuring the github-merge tool for the Las Vegas Coin repository is done in the following way:

    git config githubmerge.repository Las Vegas Coin-Project/Las Vegas Coin
...
A script to optimize png files in the Las Vegas Coin
