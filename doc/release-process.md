...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Las Vegas Coin-Project/Las Vegas Coin/blob/master/doc/translation_process.md#synchronising-translations).
...
- Detached signatures will then be committed to the [pivx-detached-sigs](https://github.com/Las Vegas Coin-Project/pivx-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Las Vegas Coin-Project/Las Vegas Coin/releases/new) with a link to the archived release notes.
